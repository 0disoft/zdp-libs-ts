...
import { CALCULATOR_MAX_INPUT_DIGITS, COMPOUND_INTEREST_MAX_POWER_DIGITS, COMPOUND_INTEREST_MAX_YEARS } from '../constants.js';
import { decimalToRational } from '../core/decimal.js';
import { ownUnitMultiplier, parseNamedDecimal, parseNamedUnitDecimal, parseOptions } from '../core/input.js';
import { failure } from '../core/result.js';
import { decimalDigitCount, formatRational, multiplyRationals, normalizeRational, powerRational, subtractRationals } from '../core/rational.js';
...
export function calculateCompoundInterest(input, options) {
    ...
    const base = normalizeRational({
        numerator: rateRational.numerator +
