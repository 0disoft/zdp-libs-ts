...
import { parseFixedUnitInteger, parseNamedDecimal, parseNamedUnitDecimal, parseOptions } from '../core/input.js';
import { failure } from '../core/result.js';
import { divideRationals, formatRational, multiplyRationals } from '../core/rational.js';
export function calculateFuelCost(input, options) {
    ...
    if (economy.value.coefficient < 0n ||
...
//# sourceMappingURL=fuel-cost.js.map