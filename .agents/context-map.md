...
| Calculator engine | `docs/contracts/calculator-engine.md`, `src/calculator-engine/index.ts`, sibling `../zdp-api-contracts/contracts/calculators/**` | `zdp_libs_ts_check`, `zdp_libs_ts_npm_pack_dry_run` |
