...
이 저장소는 ZDP TypeScript 공통 계약 package skeleton을 소유한다. 작업 전 변경 대상이 package boundary, API source handoff, schema/env/event/error/i18n/glossary contract, glossary locale copy, public export skeleton 중 어디인지 먼저 고른다.
...
- Public exports는 root, `./schema`, `./env-contract`, `./event-contracts`, `./error`, `./i18n-contract`, `./glossary-contract`다.
