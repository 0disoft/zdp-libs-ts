...
- calculator engine: `src/calculator-engine/index.ts`; external source: sibling `zdp-api-contracts/contracts/calculators/*.yaml`; coverage: `tests/calculator-engine.test.ts`
